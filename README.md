...
src-tauri/
  src/db.rs         SQLite schema + 迁移 + 查询层(含 FTS5 触发器、保留清理)
...
**v0.2.0 已交付(Phase 2.1 + 2.2)**:网络代理、系统托盘、原生通知、正则规则引擎、FTS5 搜索、完整备份、存储清理。

Phase 2.3(Google Reader API / Fever 云同步)待启动。
